...
class Library implements Externalizable {
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        out.writeObject(rentedBooks);
    }

    @Override
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        books = (ArrayList<Book>) in.readObject();
        rentedBooks = (ArrayList<Book>) in.readObject();
    }
...
public class LibraryManagementSystem_2 {
    public static void main(String[] args) {
        Library library;

        try {
            library = Library.loadState("library_2.ser");
        ...
        try {
            Library.saveState(library, "library_2.ser");
        } catch (IOException e) {
